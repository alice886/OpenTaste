...
export default function HomeSearch() {
    ...
    const handleHomeSearch = async e => {
        e.preventDefault();
        history.push(`/search?dateTime=${encodeURIComponent(searchDate)}T${encodeURIComponent(searchTime)}&covers=${encodeURIComponent(partySize)}&term=${encodeURIComponent(keyWord)}&sorting=default&page=2`)
