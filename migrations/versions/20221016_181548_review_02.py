...
Revision ID: 06089cc461f6
Revises: 
Create Date: 2022-10-16 18:15:48.236154
...
def upgrade():
    ...
    sa.Column('reserve_datetime', sa.DateTime(), nullable=False),
    ...
    sa.Column('review_body', sa.String(length=500), nullable=True),
    sa.Column('created_at', sa.DateTime(), nullable=False),
