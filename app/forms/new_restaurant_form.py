...
class RestaurantForm(FlaskForm):
    ...
    def validate_time(form,field):
        if field.data is None or not isinstance(field.data, datetime):
    ...
    price_range = SelectField('price_range',choices=[1,2,3,4],validators=[validate_integer,DataRequired()])
